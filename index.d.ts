...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a chi-square distribution.
	*
	...
	*/
	<T extends typedndarray<number>>( shape: Shape, k: number | T, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a chi-square distribution.
	*
	* @param k - degrees of freedom
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>>( k: number | T, out: U ): U;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a chi-square distribution.
	*
	* @param options - function options
